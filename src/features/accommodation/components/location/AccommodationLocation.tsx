...
import { AccommodationLocationProps } from '@/features/accommodation/types/accommodationLocation';

export const AccommodationLocation: FC<AccommodationLocationProps> = (props) => {
